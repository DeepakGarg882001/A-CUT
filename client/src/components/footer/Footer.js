      ...
      <div className="footer-canvas">
        ...
        <div className="footer-canvas-middle" >
              ...
              <div className="footer-middle-ngo">
                ...
                <p>The moto of this application is to save time during the saloon activities.</p>
              </div>
              ...
              <div className="footer-middle-info-sec">
                ...
                <div className="footer-middle-info-details">
                   <Link to="/services" className="info_items"> <p > Services </p></Link>
                   <Link to="/about" className="info_items"> <p > About </p></Link>
                   <Link to="/contact"  className="info_items"> <p > Contact </p></Link>
                   <Link to="/suggestions"  className="info_items"> <p > Any Query </p></Link>
                </div>
              </div>
